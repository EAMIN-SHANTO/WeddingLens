        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-primary-400 flex items-center">
              ...
              <a href="#" className="text-gray-400 hover:text-primary-400 flex items-center">
                <svg className="w-4 h-4 mr-1" viewBox="0 0 24 24" fill="#E4405F">
              ...
              <a href="#" className="text-gray-400 hover:text-primary-400 flex items-center">
                <svg className="w-4 h-4 mr-1" viewBox="0 0 24 24" fill="#000000">
